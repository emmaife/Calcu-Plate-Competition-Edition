...
ActiveRecord::Schema.define(version: 20140724153949) do

  create_table "age_divisions", force: true do |t|
    t.string "name"
  end
  ...
  create_table "competition_classes", force: true do |t|
    t.string "name"
  end
